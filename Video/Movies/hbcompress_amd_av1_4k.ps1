<#
.SYNOPSIS
    Batch compresses 4K movie files to AV1 using a predefined HandBrake preset.
...
.DESCRIPTION
    ...
    Encoding uses HandBrakeCLI with the user-defined "AV1 4k" preset.
    ...
    - AV1 guard: files already encoded in AV1 are skipped automatically.
...
.NOTES
    ...
    - Requires a HandBrake user preset named exactly "AV1 4k".
